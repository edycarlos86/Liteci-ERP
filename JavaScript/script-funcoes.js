  ...
  /*jQuery(function() {
    $(document).ready(function() {
      $(".somar-check").change(function() {
        var total = $('input[name="valor"]:checked').get().reduce(function(tot, el) {
    ...
    return /*Inicio Card*/'<div class="card border-dark mb-2 m-1 flex-wrap card-total" style="max-width: 20rem;">'+
      '<div class="card-header bg-primary d-flex justify-content-between valor">'+
        '<div class="form-check d-flex align-items-center">'+
          '<input type="checkbox" class="form-check-input bg-dark" onclick="somar()" id="preco" name="valor" value="10.00">'+
        '</div>'+
...
function get_nav_quitadas(){
  return '<div class="mt-2">'+
    ...
    '<input style="width:95px;" type="date" id="data-inicial">'+
  '</div>'+
  '<div class="mt-2">'+
    '<label class="mt-1" for="data-final">Data Final:</label>'+
    '<input style="width:95px;" type="date" id="data-final">'+
  '</div>'+
